...
This file contains classes for the chess squares, board, and pieces.  Should 
be imported by chess_engine

# TODO:
    Add methods for finding moves for each of the pieces.
